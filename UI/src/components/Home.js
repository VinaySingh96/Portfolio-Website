...
const Home = () => {
  ...
  return (
    <div
      className="bg-center bg-contain bg-no-repeat flex"
      style={{ backgroundImage: `url(${profile})`, height: "800px" }}
    >
      <div className="mt-20 p-10">
        ...
        <div className="text-slate-400 w-[60%] mt-6 text-lg">
          <span>
        ...
        <div className="mt-4 p-2 ml-4 flex flex-col gap-4">
          <div>
            {links.map((item, index) => {
              ...
              return (
                <div class="relative inline-flex group ml-2" key={index}>
                  <div class="absolute opacity-70 bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] blur-md group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt"></div>
                  <a
                    href="#"
                    class="relative inline-flex items-center justify-center px-2 py-2 transition-all duration-200 bg-gray-900 font-pj rounded-xl"
                    role="button"
                  >
          ...
          <div>
            <button
              class="bg-gray-700 active:bg-gray-700 hover:bg-gray-200 hover:text-gray-700 text-headings font-bold py-2 px-8 rounded text-lg flex items-center justify-between transition-all duration-200"
